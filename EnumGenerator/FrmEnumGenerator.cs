...
namespace EnumGenerator
{
    public partial class FrmEnumGenerator : Form
    {
        ...
        private void WriteOutput(Dictionary<int, string> dictionary)
        {
            ...
            {
                TxtOutput.Text += "\t" + item.Value + " = " + item.Key + "," + Environment.NewLine;
            }
        ...
        {
            _Connection = new SqlConnection(@"Server=.\SQLExpress; Integrated Security=true; Database = " + CboDatabase.SelectedValue + ";");
